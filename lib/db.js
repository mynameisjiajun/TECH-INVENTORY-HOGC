...
if (IS_VERCEL && !process.env.DATABASE_DIR) {
  console.warn(
    "Using ephemeral /tmp storage for SQLite. Data will be lost on redeploy. " +
      "Set DATABASE_DIR env var to a persistent path, or migrate to Turso/Neon for production.",
  );
}
