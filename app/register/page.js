      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="input-group">
            <label><RiKeyLine style={{ verticalAlign: 'middle' }} /> Invite Code</label>
            <input type="password" value={formData.invite_code} onChange={update('invite_code')}
              placeholder="Enter the secret invite code" required autoFocus />
          </div>
          <div className="input-group">
            <label>Display Name</label>
            <input type="text" value={formData.display_name} onChange={update('display_name')}
              placeholder="Your name (e.g., Jia Jun)" required />
          </div>
          <div className="input-group">
          ...
          <div className="input-group">
            ...
            <input type="password" value={formData.password} onChange={update('password')}
              placeholder="Choose a password (min 6 chars)" required />
          </div>
          <div className="input-group">
            <label>Confirm Password</label>
            <input type="password" value={formData.confirm_password} onChange={update('confirm_password')}
