...
export async function POST(request, { params }) {
  ...
  try {
    ...
    try {
      ...
      const returnBorrowerHandle = loanUserHandleData?.telegram_handle
        ? `@${escapeHtml(loanUserHandleData.telegram_handle.replace(/^@/, ""))}`
        : "no handle";
      ...
      console.error("laptop return channel message build failed:", channelErr?.message || channelErr);
    }
